...
public class PersonTest {
	...
	public void insertPerson() throws Throwable {
		int result = personService.insertPerson(new Person(0, "최수지", 20));
	...
	public void updatePerson() throws Throwable {
		int result = personService.updatePerson(new Person(7, "전수지", 30));
		assertNotEquals(0, result);
	}
	...
	public void deletePerson() throws Throwable {
		int result = personService.deletePerson(6);
		assertNotEquals(0, result);
	}
